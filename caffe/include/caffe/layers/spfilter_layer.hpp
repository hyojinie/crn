...
*/
#ifndef CAFFE_SPFILTER_LAYER_HPP_
#define CAFFE_SPFILTER_LAYER_HPP_
...
class SpfilterLayer : public Layer<Dtype> {
 public:
  explicit SpfilterLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "Spfilter"; }
...
#endif  // CAFFE_SPFILTER_LAYER_HPP_
